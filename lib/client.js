...
try {
    ...
    console.log("🌍 Connected to the Ravana DB")
} catch {
...
app.listen(port, () => console.log(`Ravana Server listening on port http://localhost:${port}!`));
